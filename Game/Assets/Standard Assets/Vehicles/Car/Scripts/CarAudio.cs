        ...
        private void Update()
        {
            ...
            if (m_StartedSound)
            {
                ...
                else
                {
                    ...
                    m_LowAccel.volume = lowFade*accFade*maxVolume;
                    m_LowDecel.volume = lowFade*decFade*maxVolume;
                    m_HighAccel.volume = highFade*accFade*maxVolume;
                    m_HighDecel.volume = highFade*decFade*maxVolume;
